            ...
            <ul id="sidebarnav" class="pt-4">
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Health Centres Administration</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="vaccineinventory"
                  aria-expanded="false"
                  ><i class="mdi mdi-hospital-marker"></i
                  ><span class="hide-menu">Vaccine Inventory</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="vaccineadministration"
                  aria-expanded="false"
                  ><i class="mdi mdi-hospital-building"></i
                  ><span class="hide-menu">Vaccine Administration</span></a
                >
              </li>
              <li class="sidebar-item">
                <a
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="systemsadministration"
                  aria-expanded="false"
                  ><i class="mdi mdi-account-circle"></i
                  ><span class="hide-menu">Systems Administration</span></a
                >
              </li>
